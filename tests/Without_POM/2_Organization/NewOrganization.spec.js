...
test('New_Organization',async ({page}) => {
    ...
    // let org_saved=await page.locator(`//span[@id="dtlview_Organization Name"]`).textContent()
    // if (org_name == org_saved) {
    //     console.log("Org is Created Successfully");        
    // } else {
    //     console.log("Please create the Org");
    // }
