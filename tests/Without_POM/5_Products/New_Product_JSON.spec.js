...
import prod_details from '../../../test_data/JSON/New_Product.json'
import login_details from '../../../test_data/JSON/Login.json'

test('New_Products_JSON',async ({page}) => {
    ...
    //! Navigating to New Product Page 
        ...
        await page.locator(`//input[@name="productname"]`).fill(a.productname)
        await page.locator(`//input[@id="productcode"]`).fill(a.productcode)
        ...
        await page.locator(`//input[@id="qtyinstock"]`).fill(a.qtyinstock)
